...
![npm](https://img.shields.io/npm/v/ai-toxic-check)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-toxic-check)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Toxic content detection and moderation utilities

Toxic comment detection. Analyzes text for harmful language and content moderation.
...
[![GitHub stars](https://img.shields.io/github/stars/lxgicstudios/ai-toxic-check)](https://github.com/lxgicstudios/ai-toxic-check/stargazers)
